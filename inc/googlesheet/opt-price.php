...
if (!get_option('statusTable')) {
    ...
    {
        if ((isset($var[0]->name))) {
            return preg_replace('/[^0-9]/', '', $var[0]->name) | null;
        }
        if ((isset($var[1]->name))) {
            return preg_replace('/[^0-9]/', '', $var[1]->name) | null;
        }
        if ((isset($var[2]->name))) {
            return preg_replace('/[^0-9]/', '', $var[2]->name) | null;
        }
        if ((isset($var[3]->name))) {
            return preg_replace('/[^0-9]/', '', $var[3]->name) | null;
        }
        if ((isset($var[4]->name))) {
            return preg_replace('/[^0-9]/', '', $var[4]->name) | null;
        }
        if ((isset($var[5]->name))) {
            return preg_replace('/[^0-9]/', '', $var[5]->name) | null;
        }
        if ((isset($var[6]->name))) {
            return preg_replace('/[^0-9]/', '', $var[6]->name) | null;
        }
        if ((isset($var[7]->name))) {
            return preg_replace('/[^0-9]/', '', $var[7]->name) | null;
        }
        if ((isset($var[8]->name))) {
            return preg_replace('/[^0-9]/', '', $var[8]->name) | null;
        }
        if ((isset($var[9]->name))) {
            return preg_replace('/[^0-9]/', '', $var[9]->name) | null;
        }
        if ((isset($var[10]->name))) {
            return preg_replace('/[^0-9]/', '', $var[10]->name) | null;
        }
        if ((isset($var[11]->name))) {
            return preg_replace('/[^0-9]/', '', $var[11]->name) | null;
        }
        if ((isset($var[12]->name))) {
            return preg_replace('/[^0-9]/', '', $var[12]->name) | null;
        }
        if ((isset($var[13]->name))) {
            return preg_replace('/[^0-9]/', '', $var[13]->name) | null;
        }
        if ((isset($var[14]->name))) {
            return preg_replace('/[^0-9]/', '', $var[14]->name) | null;
        }
        if ((isset($var[15]->name))) {
            return preg_replace('/[^0-9]/', '', $var[15]->name) | null;
        }
    }
